  ...
  return (
    <div className="fixed w-screen h-screen left-0 top-0 bg-black/75 z-10 flex items-center justify-center">
      <div className="bg-black  rounded-xl p-12 flex flex-col gap-4">
        {/* TOP */}
        <div onClick={onClose} className="flex items-center justify-between">
          ...
          <button onClick={onClose} className="bg-white text-black rounded-full py-2 px-4">
            Save
          </button>
        </div>
        {/* IMAGE CONTAINER */}
        ...
        <div className="flex items-center justify-between text-sm">
          ...
          <div
            className={`cursor-pointer text-black py-1 px-4 rounded-full ${
