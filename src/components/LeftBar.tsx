  ...
  return (
    <div className="h-screen sticky top-0 flex flex-col justify-between pt-2 pb-8">
      ...
      <div className="flex flex-col gap-4 items-center text-lg 2xl:items-start">
        <Link className="rounded-full flex relative hover:bg-[#181818]" href="/">
          <svg
            fill="#fff"
            width="24px"
            height="24px"
        ...
        <Link
          href="/compose/post"
          className=" bg-white w-10 h-10 text-black rounded-full 2xl:hidden  flex items-center justify-center"
        >
          <Image src="icons/post.svg" alt="new post" w={20} h={20} />
        </Link>
        <Link
          href="/compose/post"
          className="hidden 2xl:block font-bold bg-white text-black rounded-full py-2 px-20"
        >
          Post
        </Link>
      </div>
      ...
      <div className="flex items-center justify-between">
        <div className="flex gap-1">
          ...
          <div className="2xl:flex hidden  flex-col items-center justify-center">
