...
const PostInteraction = ({
  ...
  return (
    <div className="flex items-center gap-4 md:gap-6 lg:gap-8 2xl:gap-16  justify-between my-2 text-textGray">
              ...
              <path
                className={`${
                  optimisticCount.isLiked
                    ? "fill-rose-500"
                    : "group-hover:fill-rose-500 fill-textGray"
                }  `}
            ...
            <span
              className={
                optimisticCount.isLiked
                  ...
                  : `group-hover:text-rose-500 text-sm`
              }
            >
