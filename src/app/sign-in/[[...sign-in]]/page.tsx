      ...
      <div className="w-full md:w-1/2 flex flex-col gap-4">
        ...
        <SignIn.Root>
          ...
          <SignIn.Step name="sso-callback">
            <SignIn.Captcha className="mt-4" />
          </SignIn.Step>
          {/* STEP ONE => YOUR EMAIL */}
            <Clerk.Field name="identifier" className="flex flex-col gap-2 my-4">
              <Clerk.Input
            ...
            <SignIn.Action
              className="w-72 text-center text-iconBlue hover:underline text-sm"
              submit
            >
              Continue
            </SignIn.Action>
          ...
          <SignIn.Step name="verifications">
            <SignIn.Strategy name="password">
              ...
              <div className="flex w-72 justify-between">
                <SignIn.Action
                  className="text-center text-iconBlue hover:underline text-sm"
                  submit
                >
                  Continue
                </SignIn.Action>
            ...
            {/* EMAIL VERIFICATION CODE FOR PASS RESET */}
            <SignIn.Strategy name="reset_password_email_code">
              ...
              <SignIn.Action
                className="text-center text-iconBlue hover:underline mt-2 text-sm"
                submit
              >
                Continue
              </SignIn.Action>
          ...
          <SignIn.Step
            ...
            className="flex justify-around text-sm w-72"
          >
          ...
          <Link
            href="/sign-up"
            className="text-center rounded-full bg-iconBlue w-72 py-1 font-bold"
          >
            Create Account
          </Link>
